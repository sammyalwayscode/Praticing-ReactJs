    ...
    <div>
      <div class="banner-two-img" id="home">
        ...
        <div class="banner-right-side">
            ...
            <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
              <div class="position-title position-relative">
                ...
                <div class="title-wls-text text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">
                  <p>
                    ...
                    do eiusmod tempor incididunt ut labore et Lorem ipsum
                  </p>
                </div>
              </div>
              <div class="row">
              ...
              <div class="about-history my-lg-5 my-md-4 my-3">
                ...
                <p>
                  ...
                  labore et consectetur adipiscing sed do eiusmod tempor
                  incididunt ut Lorem ipsum dolor sit amet Lorem ipsum dolor sit
                  amet, eiusmod tempor incididunt ut labore et consectetur
                  adipiscing
                </p>
              </div>
          ...
          <section
            class="newsletter py-lg-4 py-md-3 py-sm-3 py-3"
            id="newsletter"
          >
            <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
              ...
              <div class="row mt-lg-4 mt-3">
                <div class="col-lg-6 col-md-6 col-sm-6 blog-two-two">
                  ...
                  <p>
                    ...
                    elit.Vestibulum nibh urna Lorem ipsum dolor sit amet,
              ...
              <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 contact-w3pvt-address">
                  <div class="footer-top">
                    ...
                    <p>
                      <span>Address</span> :Melbourne St,South <br />
                      Birbane 4101 Austraila.
                    </p>
                    <p class="pt-2">
                      <span> Phone</span> :+(000) 123 4565 32
                    </p>
                    <p class="pt-2">
                      <span>Email</span> :
